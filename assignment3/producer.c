...
int main(int argc, char* argv[]) {
	...
	for (int i = 0; i < num_items; i++) {
		...
		sem_wait(empty); // TODO: Wait for empty slot

		sem_wait(mutex); // TODO: Enter critical section
		...
		sem_post(mutex); // TODO: Exit critical section

		sem_post(full); // TODO: Signal item available
